...
* Please name your files with the paradigm LabX_FirstinitialYourlastname.Rmd (e.g. Lab1_LPark.Rmd), so that your lab instructor can identify each Rmarkdown-file.
