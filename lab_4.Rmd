...
`epi.2by2()` works just like `mAssoc()`. We need to [rearrange our tables](https://dghi-biostat.github.io/biostatlab/lab_3.html#step-2-rearrange-table-with-fliptable) so that our outcome of interest and exposure of interest are in the top-left corner of each table. 
...
<aside> ![More than eye](images/more_eye.png)</aside>
...
Since we have pre-determined our "reference" and "index" levels, and know that a risk difference is [defined](https://dghi-biostat.github.io/biostatlab/lab_2.html#reference-and-index-levels-of-a-categorical-variable) as "risk in the level of interest minus risk in the reference level", what's the result when our reference level is also our level of interest? 
...
<aside>I promise you can figure it out. This one is pretty straightforward </aside>
