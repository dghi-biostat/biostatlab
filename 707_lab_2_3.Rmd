...
title: "Lab 2 & 3 (707)"
description: | 
    __Lab 02 Due:__ `r readxl::read_excel('files/due_dates.xlsx')[7,2]` by `r readxl::read_excel('files/due_dates.xlsx')[7,3]`
    <br></br>
    (__Note:__ There are no written questions to turn in for Lab 2.)
    <br></br>
    __Lab 03 Due:__ `r readxl::read_excel('files/due_dates.xlsx')[8,2]` by `r readxl::read_excel('files/due_dates.xlsx')[8,3]`
