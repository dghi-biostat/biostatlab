...
[![Show All Panes](images/show_windows.png)](images/show_windows.png)
...
<aside>
```{r, out.width = "10%", fig.cap = "I Eat Data Science for Breakfast"}
