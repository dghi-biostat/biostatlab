...
title: "Lab 2 (705)"
description: |
    __Due:__ `r readxl::read_excel('files/due_dates.xlsx')[3,2]` by `r readxl::read_excel('files/due_dates.xlsx')[3,3]`
date: "`r Sys.Date()`"
...
* [__R Markdown file for Lab 2__](assignments/lab2_705[assignment].Rmd)
...
* [__Excel document for Tables 1 & 2__](assignments/lab2_705_tables[assignment].xlsx)
...
If you haven’t already, download the Excel file that’s linked [at the top of this webpage](https://dghi-biostat.github.io/biostatlab/docs/705_lab_2.html#lab-materials). Then open the file, which is named `Lab2_Tables.xlsx`.
