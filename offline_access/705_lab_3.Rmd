...
* [__R Markdown file for Lab 3__](https://github.com/dghi-biostat/biostatlab/blob/main/assignments/lab3_705[assignment].Rmd)
...
* [__Excel document with Tables 1, 2, and 3__](https://github.com/dghi-biostat/biostatlab/blob/main/assignments/lab3_705_tables.xlsx)
...
This table also includes statistical measures (Chi-Sq and Fisherâ€™s exact test) of the association between mortality status and the variables in the table.
