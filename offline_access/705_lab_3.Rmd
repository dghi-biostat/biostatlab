...
title: "Lab 3 (705)"
description: |
    __Due:__ `r read.csv('../files/due_dates.csv')[4,2]` by `r read.csv('../files/due_dates.csv')[4,3]`
date: "`r Sys.Date()`"
...
* [__R Markdown file for Lab 3__](https://github.com/dghi-biostat/biostatlab/blob/main/assignments/lab3_705_fall2021.Rmd)
...
* [__Excel document with Tables 1, 2, and 3__](https://github.com/dghi-biostat/biostatlab/blob/main/assignments/Lab3_Tables.xlsx)
...
<aside>Reminder that you can find Tables 1-3 in the Excel file provided in the [Lab Materials](https://dghi-biostat.github.io/biostatlab/lab_3.html#lab-materials) for this lab </aside>
