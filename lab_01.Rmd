...
```{r echo = TRUE, eval = FALSE}
qq_data <- qqnorm(regdat$weight)
```

Here's an example of the first 10 datapoints in our qq_data object, with two columns aligning "Observed Values" and their respective "Z-values".
