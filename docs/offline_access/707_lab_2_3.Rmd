...
```{r echo = FALSE, layout = "shaded"}
image_link("../images/lab02_validityprecision.png", url = "../files/lab02_validityprecision.pdf")
```
...
[Link to 705 lab 1, tabular analysis](https://dghi-biostat.github.io/biostatlab/docs/705_lab_1.html#cross-tabulation-with-group_by-and-summarize)
...
We could also join `model_predict` back to our original data [for the purpsoe of plotting a line of best fit with confidence intervals](https://dghi-biostat.github.io/biostatlab/docs/707_lab_2_3.html#plotting-risks-versus-exposures).
...
Refer back to the section on [using `predict.lm()` to generate predictions and confidence intervals](https://dghi-biostat.github.io/biostatlab/docs/707_lab_2_3.html#generate-predicted-values-from-linear-models), where we generated upper and lower confidence limits from a model along with a model's predicted values.
...
Critical point â€“ the models must be strictly comparable, so
...
* categories based on values used to classify people as â€˜underweightâ€™, â€˜normalâ€™, â€˜overweightâ€™ or â€˜obeseâ€™)  
