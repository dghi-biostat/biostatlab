...
* [__R Markdown file for Lab 1__](https://github.com/dghi-biostat/biostatlab/blob/main/assignments/lab1_705[assignment].Rmd)
...
* [__Excel document for Tables 1 & 2__](https://github.com/dghi-biostat/biostatlab/blob/main/assignments/lab1_705_tables[assignment].xlsx)
...
<aside>
Find more useful keyboard shortcuts [here](help_rstudio.html#rmarkdown-keyboard-shortcuts)
</aside>


## Task 2: Recode variables

Similar to Lab 0, construct the following derived variables (Tasks 2a - 2e) using a pipe (`%>%`) and `mutate()`. For each, examine the component variables for coded special values (i.e. "NA") and be sure to set derived variable values appropriately. For categorical variables, you will be expected to use `case_when()` to create conditional clauses, just as you did [in Lab 0](705_lab_0.html#task-8-create-variable-magec) to derive `magec`. 

<aside>

__Some helpful links:__

[Using pipes and mutate() in the previous lab](705_lab_0.html#task-6-create-variable-mage)

[Using case_when() to derive `magec`](705_lab_0.html#task-8-create-variable-magec)

[More on pipes](help_jargon.html#magrittrpipe)

[More on factors](help_jargon.html#factor)
...
Navigate to [this page](help_ggplot2.html) for {ggplot2} resources. The page also includes [our own tutorial](help_ggplot2.html#core-competencies-for-705-lab) that details the concepts specifically required to complete these labs.
...
If you need a little more guidance, learn to create a boxplot [here](help_ggplot2.html#create-a-boxplot-with-geom_boxplot)

And learn how to create a stratified boxplot [here](help_ggplot2.html#generate-a-stratified-boxplot-by-adding-a-y-aesthetic)

## Task 5: Frequency table (Table 1)

If you haven't already, download the Excel file that's linked [at the top of this webpage](705_lab_1.html#lab-materials). Then open the file, which is named `Lab1_Tables.xlsx`. 
