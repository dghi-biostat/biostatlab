...
Label all variables and the coded values for the categorical ones using the `factor()` command. That is, add meaningful labels to both the variable name itself and to the levels (i.e. categories) of the categorical variable to make printed output more readable".
