...
title: "Lab 1"
description: |
  Biostatistics & Epi, Lab 1 - GLHLTH 705. Create derived variables for birth order (bord5), sex (male), mheight, mweight, mbmi. Frequency histograms, boxplots, frequency table, and data dictionary.
date: "`r Sys.Date()`"
