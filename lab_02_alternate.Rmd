...
title: "Lab 02 (707)"
description: |
    __Due:__ March 18, 2022 by 14:00 ET
date: "`r Sys.Date()`"
...
outline
                TASK                        STATUS
- import data from .csv                     not started
- plots with {ggplot2}                      not started
- creating new variables                    not started
- skewness and kurtosis                     not started
- pearson and spearman rank CC              not started
...
## NOTE: Using <details> features to create collapsible sections.
## These are structured with the following syntax:
...
<details class = "section-head">
<summary>Tabular analysis (frequency counts)</summary>
...
<details class = "section-head">
<summary>Summary of GLM</summary>
# Summary of GLM
...
<details class = "section-head">
<summary>Confidence Limit Difference and Ratios (CLD/CLR)</summary>
...
<details class = "section-head">
<summary>Nominal, Ordinal, and Disjoint Indicator variables</summary>
...
<details class = "section-head">
<summary>Log-linear and Logit models with `glm()`</summary>
